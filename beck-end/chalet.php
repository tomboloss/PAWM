								...
								<div class="x_title">
									...
									<ul class="nav navbar-right panel_toolbox">
										<button class="btn btn-primary btn-block">
											<a href="add_chalet.php" style="color: white">Aggiungi Chalet</a>
										</button>
									</ul>
												...
												<table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                                    ...
                                                    <tboydy>
                                                        <?php
                                                            ...
                                                            $rs = mysqli_query($conn, "SELECT chalet.chalet_id, chalet.ragione_sociale, chalet.numero_concessione, chalet.telefono, 
                                                                                        CONCAT(chalet.indirizzo,' , ',chalet.cap,' - ',chalet.citta, ' (',chalet.provincia, ')') AS indirizzocompleto,
                                                                                        users.username, users.email FROM chalet INNER JOIN users ON chalet.user_id = users.user_id");
