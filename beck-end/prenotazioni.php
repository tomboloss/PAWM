								...
								<div class="x_title">
									...
									<ul class="nav navbar-right panel_toolbox">
										<button class="btn btn-primary btn-block">
											<a href="add_prenotazione.php" style="color: white">Aggiungi Prenotazione</a>
										</button>
									</ul>
                                                        ...
                                                        <?php
                                                            ...
                                                            if(isset($_SESSION['user_id'])) {
                                                                $user_id = $_SESSION['user_id'];
                                                                 //query che tira fuori gli ombrelloni prenotati 
                                                              $rs3 = mysqli_query($conn, "SELECT *  
                                                                ...
                                                                //query che tira fuori gli ombrelloni liberi
                                                                $rs2 = mysqli_query($conn, "SELECT *
                                                                FROM ombrelloni INNER JOIN chalet ON ombrelloni.chalet_id = chalet.chalet_id 
                                                                INNER JOIN users ON chalet.user_id = users.user_id 
                                                                left JOIN prenotazioni ON ombrelloni.ombrellone_id = prenotazioni.ombrelloni 
                                                                WHERE users.user_id= $user_id and prenotazioni.nome is null && prenotazioni.cognome is null"); 

                                                              
                                                                
                                                                     while($row = mysqli_fetch_array($rs1)){ //stampo i prenotati."   data_s". $data_s
                                                                            ...
                                                                            echo "<td>".$row['data_arrivo']."</td>";
                                                                            echo "<td>".$row['data_partenza']."</td>";
                                                                            echo "<td>".$row['qta_lettini']."</td>";
                                                                            echo "<td>".$row['qta_sdraie']."</td>";
                                                                            echo "<td>".$row['qta_registe']."</td>";
                                                                            echo "<td>".$row['flag_saldo']."</td>";
                                                                            echo "<td>".$row['ragione_sociale']."</td>";
                                                                            

                                                                            echo"<td>
                                                                            <a href=\"delete_prenotazioni.php?prenotazioni_id=$row[prenotazione_id]\" onClick=\"return confirm('Sei sicuro di voler eliminare questa Prenotazione?')\"><i class='fa fa-trash fa-2x'></i></a>
                                                                            </td>";
                                                                    ...
                                                                    while($row = mysqli_fetch_array($rs2)){ //stampo gli ombrelloni liberi
