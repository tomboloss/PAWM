                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form action="add_prenotazione_action.php" method="POST">
                                            ...
                                            <div class="item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3 label-align">Quantità lettini<span class="required">*</span></label>
                                                <div class="col-md-6 col-sm-6 ">
                                                    <input type="text" id="qta_lettini" name="qta_lettini" required="required" class="form-control" placeholder="Inserisci la quantità di lettini">
                                                </div>
                                            </div>
                                            <div class="item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3 label-align">Quantità sdraie<span class="required">*</span></label>
                                                <div class="col-md-6 col-sm-6 ">
                                                    <input type="text" id="qta_sdraie" name="qta_sdraie" required="required" class="form-control" placeholder="Inserisci la quantità di sdraie">
                                                </div>
                                            </div>
                                            <div class="item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3 label-align">Quantità registe<span class="required">*</span></label>
                                                <div class="col-md-6 col-sm-6 ">
                                                    <input type="text" id="qta_registe" name="qta_registe" required="required" class="form-control" placeholder="Inserisci la quantità di registe">
                                                </div>
                                            </div>
                                            <div class="item form-group">
